...
final class ExternalThumbnailRenderer: Sendable {
    static let ffmpegPathVariable = "OWL_FFMPEG_PATH"
    static let mpvPathVariable = "OWL_MPV_PATH"
    ...
    private static let workQueue = DispatchQueue(
        label: "me.limboy.owl.ExternalThumbnailRenderer",
        qos: .userInitiated
    )
    ...
    private static let filmstripQueue = DispatchQueue(
        label: "me.limboy.owl.ExternalThumbnailRenderer.filmstrip",
        qos: .utility
    )
    ...
    private static func mpvImage(
        ...
        let directory = fileManager.temporaryDirectory
            .appendingPathComponent("OwlThumbnails", isDirectory: true)
