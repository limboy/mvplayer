...
![MVPlayer playing an episode with a hover frame preview and subtitles, next to a folder queue](Assets/screenshots/screenshot-1.png) ![](Assets/screenshots/screenshot-2.webp)
